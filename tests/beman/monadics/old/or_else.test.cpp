...
TEST_CASE("optional-has-box-traits") { STATIC_REQUIRE(has_box_traits<std::optional<int>>); }

TEST_CASE("with-value") {
    constexpr auto result = std::optional{10} | or_else([]() { return std::optional{2.0}; });
...
TEST_CASE("without-value") {
    constexpr auto result = std::optional<int>{} | or_else([]() { return std::optional{2.0}; });
...
TEST_CASE("shared-ptr-with-value") {
    ...
    const auto result = ptr | or_else([]() { return std::make_shared<double>(2.0); });
...
TEST_CASE("shared-ptr-rvalue-value") {
    const auto result = std::make_shared<int>(10) | or_else([]() { return std::shared_ptr<double>{}; });

    REQUIRE(static_cast<bool>(result) == true);
}

TEST_CASE("my-expected-with-value") {
    constexpr auto result = helpers::expected<int, float>{10} | or_else([](float&& e) {
...
TEST_CASE("my-expected-without-value") {
    constexpr auto result =
        helpers::expected<int, double>{1.0} | or_else([](auto&& e) { return helpers::expected<int, double>{e * 10}; });
...
TEST_CASE("my-expected-void-with-value") {
    constexpr auto result = helpers::expected<void, float>{} | or_else([](float&& e) {
...
TEST_CASE("my-expected-void-without-value") {
    constexpr auto result = helpers::expected<void, double>{10.0} | or_else([](double&&) {
                                return helpers::expected<void, std::string_view>{std::string_view{"ups"}};
                            });
