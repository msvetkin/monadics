...
TEST_CASE("void-value-return-same-error") {
  constexpr auto result = helpers::expected<void, int>{}
      | or_else([] (auto e) {
          return helpers::expected<void, int>(e * 2);
      });
...
TEST_CASE("void-value-return-another-error") {
  constexpr auto result = helpers::expected<void, int>{}
      | or_else([] (auto e) {
          return helpers::expected<void, double>(e * 2.0);
      });
...
TEST_CASE("void-value-return-same-error-2") {
  constexpr auto result = helpers::expected<void, int>{20}
      | or_else([] (auto e) {
          return helpers::expected<void, int>(e * 2);
      });
...
TEST_CASE("void-value-return-another-error-2") {
  constexpr auto result = helpers::expected<void, int>{1}
      | or_else([] (auto e) {
          return helpers::expected<void, double>(e * 2.0);
      });
...
TEST_CASE("value-return-same-error") {
  constexpr auto result = helpers::expected<int, double>{}
      | or_else([] (auto e) {
          return helpers::expected<int, double>(e + 1);
      });
...
TEST_CASE("value-return-another-error") {
  constexpr auto result = helpers::expected<int, double>{}
      | or_else([] (auto e) {
          return helpers::expected<int, float>(float(e));
      });
...
TEST_CASE("value-return-same-error-2") {
  constexpr auto result = helpers::expected<int, double>{2.0}
      | or_else([] (auto e) {
          return helpers::expected<int, double>(e + 1);
      });
...
TEST_CASE("value-return-another-error-2") {
  constexpr auto result = helpers::expected<double, char>{'c'}
      | or_else([] (auto e) {
          return helpers::expected<double, int>(static_cast<int>(e));
      });
